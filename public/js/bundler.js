      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'logging out successfully!');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:3000/api/v1/users/updatePassword' : 'http://localhost:3000/api/v1/users/updateMe'; // thuc hien tao req den sever
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidnV0cm5na2llbiIsImEiOiJjbDFod3Fuc2swbnRmM2RxdXBtNXlvMXJpIn0.YTx8m4DC0E0j4HAQ9j307A';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51KlDwjLQx2naAgTNP9rhjHxYeOQILa2ACzAlTVlQJiBPhJ1MHBCYcEEeqi1Rlgx5E9Y04Ly1pxqhDLs2m2oyDEXH00M5QGTYpJ');
            _context.prev = 1;
            _context.next = 4;
...
var formUserData = document.querySelector('.form.form-user-data');
var logOutBtn = document.querySelector('.nav__el--logout');
var passwordForm = document.querySelector('.form.form-user-password');
...
if (passwordForm) {
  passwordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var savePassword, currentPassword, newPassword, newPasswordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              savePassword = document.querySelector('.btn--password');
              ...
              _context.next = 8;
              return (0, _updateSetting.update)({
